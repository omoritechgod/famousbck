...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/admin/quotes/{id}', [QuoteRequestController::class, 'show']);
    Route::delete('/admin/quotes/{id}', [QuoteRequestController::class, 'destroy']);
    Route::put('/admin/quotes/{id}/status', [QuoteRequestController::class, 'updateStatus']);
});
